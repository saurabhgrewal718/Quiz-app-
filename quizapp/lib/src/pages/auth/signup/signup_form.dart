...
class _SignupFormState extends State<SignupForm> {
  ...
  void _saveForm() async{
    ...
    if(isValid){
      ...
      try{
        //signup
        // var authResult = await _auth.createUserWithEmailAndPassword(email: _email.trim(), password: _password.trim());
        ...
        Navigator.of(context).pushReplacementNamed(SignOne.routeName,
